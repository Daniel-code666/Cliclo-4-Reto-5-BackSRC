...
public class UserController {
    ...
    @GetMapping("/birthday/{birthtday}")
    public List<User> getUserByMonthBirthtDay(@PathVariable("birthtday") String monthBirthtDay){
        return service.getUsersByMonthBirthtDay(monthBirthtDay);
    }
}
